...
class LtpParser():
    def __init__(self):
        ...
        self.cwsmodel = os.path.join(os.getcwd(),'ltpdata','cws.model')
        self.posmodel = os.path.join(os.getcwd(),'ltpdata','pos.model')
        self.parsermodel = os.path.join(os.getcwd(),'ltpdata','parser.model')
        self.nermodel = os.path.join(os.getcwd(),'ltpdata','ner.model')

        self.segmentor.load(self.cwsmodel)

        self.postagger = Postagger()
        self.postagger.load(self.posmodel)

        self.parser = Parser()
        self.parser.load(self.parsermodel)

        self.recognizer = NamedEntityRecognizer()
        self.recognizer.load(self.nermodel)
